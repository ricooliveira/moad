...
one.user.shiftband.ild = function(user, history){
  ...
  S = 1 # considering a unique optimum recommendation for the whole user history
  TRIALS = 20000 # ajustable
  ...
  for (day in user.history.unique){
    ...
    real.scenario = ild.2.scenario.no(ild.day)
  ...
  fwrite(df,
           paste0(address,"resultsshiftbandall/shiftband.all.ild.daily.user",user,".txt"), 
