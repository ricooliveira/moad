...
user.mab = function(u, iterations, EPSILON){
  ...
  mean.reward.affinity = rep(0.0, NARTISTS)
  mean.reward.diversity = rep(0.0, NARTISTS)
  ...
  for(iter in 1:iterations) {
    ...
    fwrite(df,
           paste0(address, "resultsmomabgreedynocf/rewards.user", u, ".egreedy.", iterations,"iter.epsilon03.noinit.txt"),
...
a = Sys.time()
#EPSILON = 0.3
#user.mab(7687, 201, EPSILON)
pblapply(users[1:30], user.mab, 1000, EPSILON)
print(Sys.time() - a)
