...
calculate.regrets = function(user){
  ...
  scenarios = fread(paste0(address, "resultsshiftbandalpha01beta05gamma05/shiftband.alpha01.beta05.gamma05.ild.daily.user", user,".txt"),
        sep = ",", header = F)
  ...
  fwrite(mean.regret,
         paste0(address,"resultsshiftbandalpha01beta05gamma05/shiftband.alpha01.beta05.gamma05.daily.regret.user", user, ".txt"),
         row.names = FALSE, col.names = FALSE, sep = "\t")
