...
```{r}
cluster_contemporaneity = list(weights = wmd.contemporaneity, k = kmeans(wmd.contemporaneity, 2))
cluster_locality = list(weights = wmd.localities, k = kmeans(wmd.localities, 2))
cluster_genre = list(weights = wmd.genre, k = kmeans(wmd.genre, 2))

cluster_contemporaneity$k$centers
cluster_locality$k$centers
cluster_genre$k$centers[,1:10]
```
...
create_points = function(propensities, aspect){
  ...
  propensities = bind_rows(propensities_1, propensities_2)
...
user.propensity[which(user.propensity$contemporaneity == 1),"contemporaneity"] = 0
user.propensity[which(user.propensity$contemporaneity == 2),"contemporaneity"] = 1
...
fwrite(user.propensity,
       "data/user.propensity.word2vec.wmd.txt",
