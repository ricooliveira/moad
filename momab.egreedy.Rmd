...
user.mab = function(u, iterations, EPSILON){
  ...
  for(iter in 1:iterations) {
    ...
    reward.scalarized = scalarize(mean.reward.diversity, mean.reward.affinity)
    # test
    # i=1
    for(i in 1:REC.SIZE){
      # drawn = runif(1, 0, RANGE.MAX)
      # if(drawn > EPSILON * RANGE.MAX){
      #   rec.list[i] = which.max(reward.scalarized[i,])
      # } else {
    ...
    fwrite(df,
           paste0(address, "resultsmomabts/rewards.user", u, ".iter", iterations,".egreedy2.txt"),
