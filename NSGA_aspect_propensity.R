...
########## Old contemporaneity metric #############
# # boundings for Contemporaneity
# earliest.year = min(artist.data$debut)
# latest.year = 2018L # the year the database was collected
# year.gap = latest.year = earliest.year
# 
# # normalize debut
# for(i in 1:nrow(artist.data)){
#   artist.data[i, "debut"] = (artist.data[i, "debut"] - earliest.year) / year.gap
#   
# }
